...
namespace WebtoonStoreForm
{
	partial class Main
	{
		...
		private void InitializeComponent( )
		{
			...
			this.CANCEL_BUTTON = new WebtoonStoreForm.Interface.FlatButton();
			this.REQUEST_BUTTON = new WebtoonStoreForm.Interface.FlatButton();
			this.downloadProgress = new WebtoonStoreForm.Interface.FlatProgressBar();
			this.MINIMIZE_BUTTON = new WebtoonStoreForm.Interface.FlatImageButton();
			...
			this.backgroundImage.Image = global::WebtoonStoreForm.Properties.Resources.background;
			...
			this.CANCEL_BUTTON.NormalStateBackgroundColor = System.Drawing.Color.LightCoral;
