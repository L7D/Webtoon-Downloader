namespace WebtoonStoreForm.Interface
{
	partial class NotifyBoxInterface
	{
		...
		private void InitializeComponent( )
		{
			...
			this.TITLE_LABEL = new WebtoonStoreForm.Interface.CustomLabel();
			this.MESSAGE_LABEL = new System.Windows.Forms.Label();
			this.TYPE_ICON = new System.Windows.Forms.PictureBox();
			this.Yes_Button = new WebtoonStoreForm.Interface.FlatButton();
			this.NO_Button = new WebtoonStoreForm.Interface.FlatButton();
			this.OK_Button = new WebtoonStoreForm.Interface.FlatButton();
			...
			this.TYPE_ICON.Image = global::WebtoonStoreForm.Properties.Resources.WARNING_ICON;
